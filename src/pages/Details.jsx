  ...
  if (!product) {
    return (
      ...
      >
        ...
        <Link to="/" style={{ fontSize: '1.3em', fontFamily: 'cursive' }}>
          Ana səhifəyə dön
        </Link>
      </div>
    );
      ...
      <div className="details-container">
        ...
        <div className="details-content">
          ...
          <div className="order-btns">
            <button
              className="whatsapp-button toBasket-btn"
            ...
            <button
              ...
              onClick={() =>
                window.open('https://wa.me/994702549600', '_blank')
              }
            >
              Whatsapp ilə sifariş{' '}
              <FaWhatsapp className="wp-icon" style={{ marginLeft: '10px' }} />
            </button>
          </div>
        </div>
      </div>
